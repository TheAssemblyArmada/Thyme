...
public:
    ...
    __forceinline void Rotate_X(float angle)
    {
    ...
    __forceinline void Rotate_Y(float angle)
    {
    ...
    __forceinline Vector3 Mul(const Vector3 &b)
    {
    ...
    __forceinline static float Dot_Product(const Vector3 &a, const Vector3 &b)
    {
        return a * b;
    }
    ...
    {
        captain_assert(!(set_result == &a || set_result == &b));
        set_result->X = (a.Y * b.Z - a.Z * b.Y);
        set_result->Y = (a.Z * b.X - a.X * b.Z);
        set_result->Z = (a.X * b.Y - a.Y * b.X);
    }

    __forceinline static float Cross_Product_X(const Vector3 &a, const Vector3 &b)
    {
        return a.Y * b.Z - a.Z * b.Y;
    }

    __forceinline static float Cross_Product_Y(const Vector3 &a, const Vector3 &b)
    {
        return a.Z * b.X - a.X * b.Z;
    }

    __forceinline static float Cross_Product_Z(const Vector3 &a, const Vector3 &b)
    {
    ...
    __forceinline Vector3 Abs() const
    {
        return Vector3(GameMath::Fabs(X), GameMath::Fabs(Y), GameMath::Fabs(Z));
    }
    ...
    float Quick_Length() const
    {
        ...
        if ( mid < min ) {
            tmp = mid; mid = min; min = mid;
        }

        return max + (11.0f / 32.0f) * mid + (1.0f / 4.0f) * min;
    }

    __forceinline static Vector3 Replicate(float n)
    {
