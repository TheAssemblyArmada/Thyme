...
const FieldParse AudioSettings::s_audioSettingsParseTable[] = {
    ...
    FIELD_PARSE_SPEAKER_TYPE("Default2DSpeakerType", AudioSettings, m_default2DSpeakerType),
    FIELD_PARSE_SPEAKER_TYPE("Default3DSpeakerType", AudioSettings, m_default3DSpeakerType),
