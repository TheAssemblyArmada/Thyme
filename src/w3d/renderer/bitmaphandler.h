...
{
public:
    static void Create_Mipmap_B8G8R8A8(uint8_t *dest_surface, unsigned dest_surface_pitch, uint8_t *src_surface,
        unsigned src_surface_pitch, unsigned width, unsigned height);
    static void Copy_Image_Generate_Mipmap(unsigned width, unsigned height, uint8_t *dest_surface, unsigned dest_pitch,
        WW3DFormat dest_format, uint8_t *src_surface, unsigned src_pitch, WW3DFormat src_format, uint8_t *mip_surface,
        unsigned mip_pitch, const Vector3 &adjust);
    static void Copy_Image(uint8_t *dest_surface, unsigned dest_surface_width, unsigned dest_surface_height,
