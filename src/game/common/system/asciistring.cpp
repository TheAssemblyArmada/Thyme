...
/**
 * Forms a string from paramters to print to console.
 */
...
/**
 * Forms a string from paramters to print to console. Format variant for convenience. Not used in the original code.
 */
