...
const FieldParse GlobalData::s_fieldParseTable[] = {
    ...
    FIELD_PARSE_DURATION_UNSIGNED_INT("HistoricDamageLimit", GlobalData, m_historicDamageLimit),
    ...
    FIELD_PARSE_DURATION_UNSIGNED_INT("BaseRegenDelay", GlobalData, m_baseRegenDelay),
    ...
    FIELD_PARSE_DURATION_UNSIGNED_INT("UnlookPersistDuration", GlobalData, m_unlookPersistDuration),
