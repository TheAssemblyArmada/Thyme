...
ARRAY_DEF(0x00A42784, w3dbasetexture_t, DX8Wrapper::s_textures, MAX_TEXTURE_STAGES);
void *&DX8Wrapper::s_shadowMap = Make_Global<void *>(0x00A47EBC);
void *&DX8Wrapper::s_hwnd = Make_Global<void *>(0x00A47EC4);
ARRAY_DEF(0x00A46CC0, unsigned, DX8Wrapper::s_renderStates, 256);
ARRAY2D_DEF(0x00A46880, unsigned, DX8Wrapper::s_textureStageStates, MAX_TEXTURE_STAGES, 32);
ARRAY_DEF(0x00A47778, Vector4, DX8Wrapper::s_vertexShaderConstants, 96);
ARRAY_DEF(0x00A427C0, unsigned, DX8Wrapper::s_pixelShaderConstants, 32);
...
int &DX8Wrapper::s_currentRenderDevice = Make_Global<int>(0x00A15CDC);
...
int &DX8Wrapper::s_textureBitDepth = Make_Global<int>(0x00A15CEC);
ARRAY_DEF(0x00A4277C, bool, DX8Wrapper::s_currentLightEnables, 4);
...
// drawgroupinfo.cpp
class DrawGroupInfo;
DrawGroupInfo *&g_theDrawGroupInfo = Make_Global<DrawGroupInfo *>(0x04CAA52C);
