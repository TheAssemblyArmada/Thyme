...
void W3DTankTruckDrawModuleData::Build_Field_Parse(MultiIniFieldParse &p)
{
    ...
    static FieldParse dataFieldParse[] = {
        FIELD_PARSE_ASCIISTRING("Dust", W3DTankTruckDrawModuleData, m_dustEffectName),
        FIELD_PARSE_ASCIISTRING("DirtSpray", W3DTankTruckDrawModuleData, m_dirtEffectName),
        FIELD_PARSE_ASCIISTRING("PowerslideSpray", W3DTankTruckDrawModuleData, m_powerslideEffectName),
        FIELD_PARSE_ASCIISTRING("LeftFrontTireBone", W3DTankTruckDrawModuleData, m_frontLeftTireBoneName),
        FIELD_PARSE_ASCIISTRING("RightFrontTireBone", W3DTankTruckDrawModuleData, m_frontRightTireBoneName),
        FIELD_PARSE_ASCIISTRING("LeftRearTireBone", W3DTankTruckDrawModuleData, m_rearLeftTireBoneName),
        FIELD_PARSE_ASCIISTRING("RightRearTireBone", W3DTankTruckDrawModuleData, m_rearRightTireBoneName),
        FIELD_PARSE_ASCIISTRING("MidLeftFrontTireBone", W3DTankTruckDrawModuleData, m_midFrontLeftTireBoneName),
