...
public:
    ...
    virtual int32_t Iterate_Drawables_In_Region(IRegion2D *r, bool (*func)(Drawable *, void *), void *) override;
    ...
    virtual void Move_Camera_To(const Coord3D *o, int32_t i1, int32_t i2, bool b, float f1, float f2) override;
    virtual void Move_Camera_Along_Waypoint_Path(Waypoint *w, int32_t i1, int32_t i2, bool b, float f1, float f2) override;
    virtual bool Is_Camera_Movement_Finished() override;
    virtual void Camera_Mod_Final_Zoom(float f1, float f2, float f3) override;
    virtual void Camera_Mod_Rolling_Average(int32_t i) override;
    virtual void Camera_Mod_Final_Time_Multiplier(int32_t i) override;
    ...
    virtual void Set_Fade_Parameters(int32_t frames, int32_t direction) override;
    virtual void Set_3D_Wireframe_Mode(bool on) override;
    virtual void Reset_Camera(const Coord3D *o, int32_t i, float f1, float f2) override;
    virtual void Rotate_Camera(float f1, int32_t i, float f2, float f3) override;
    virtual void Rotate_Camera_Toward_Object(ObjectID id, int32_t i1, int32_t i2, float f1, float f2) override;
    virtual void Rotate_Camera_Toward_Position(const Coord3D *o, int32_t i, float f1, float f2, bool b) override;
    virtual bool Is_Time_Frozen() override;
    virtual int32_t Get_Time_Multiplier() override;
    virtual void Set_Time_Multiplier(int32_t multiplier) override;
    virtual void Set_Default_View(float f1, float f2, float f3) override;
    virtual void Zoom_Camera(float f1, int32_t i, float f2, float f3) override;
    virtual void Pitch_Camera(float f1, int32_t i, float f2, float f3) override;
    ...
    virtual int32_t World_To_Screen_Tri_Return(const Coord3D *o1, ICoord2D *o2) override;
