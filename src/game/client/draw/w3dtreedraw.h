...
public:
    ...
    ~W3DTreeDrawModuleData() override {}
    const W3DTreeDrawModuleData *Get_As_W3D_Tree_Draw_Module_Data() const override { return this; }
...
public:
    ...
    void Load_Post_Process() override { DrawModule::Load_Post_Process(); }
