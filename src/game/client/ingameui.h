...
struct RadiusDecalTemplate
{
    Utf8String Texture;
    int Style;
    float OpacityMin;
    float OpacityMax;
    int OpacityThrobTime;
    int Color;
    bool OnlyVisibleToOwningPlayer;
};
...
public:
    ...
    virtual void Message(wchar_t const *message, ...);
    virtual void Message(char const *message, ...);
...
protected:
    ...
    bool m_inputEnabled;
    std::list<WindowLayout *> m_windowLayoutList;
    Utf8String m_currentlyPlayingMovie;
    std::list<Drawable *> m_selectedDrawables;
    std::list<Drawable *> m_selectedLocalDrawables;
    ...
    int m_FrameSelectionChanged;
    int m_doubleClickCounter;
    Coord3D m_radiusDecalPos;
    ...
    unsigned int m_tooltipsDisabled;
    ...
    RadiusCursorType m_radiusDecalType;
    ...
    bool m_unk4;
    bool m_unk5;
    bool m_cameraRotateLeft;
    bool m_cameraRotateRight;
    bool m_cameraZoomIn;
    bool m_unk6;
    bool m_cameraZoomOut;
    ...
    int m_idleWorkerCount;
    DrawableID m_soloNexusElectedDrawableID;
};
