...
public:
    ~Line3DClass() override {}
    Line3DClass *Clone() const override { return new Line3DClass(*this); }
    int Class_ID() const override { return CLASSID_LINE3D; }
    ...
    void Set_Sort_Level(int level) override { m_sortLevel = level; }
