...
void PlayerTemplateStore::Parse_Player_Template_Definition(INI *ini)
{
    ...
    static const FieldParse _parse_table[] = { 
        ...
        FIELD_PARSE_START_MONEY("StartMoney", PlayerTemplate, m_money),
        ...
        FIELD_PARSE_PRODUCTION_COST_CHANGE("ProductionCostChange"),
        FIELD_PARSE_PRODUCTION_TIME_CHANGE("ProductionTimeChange"),
        FIELD_PARSE_PRODUCTION_VETERANCY_LEVEL("ProductionVeterancyLevel"),
        FIELD_PARSE_SCIENCE_VECTOR("IntrinsicSciences", PlayerTemplate, m_intrinsicSciences),
        ...
        FIELD_PARSE_INT("SpecialPowerShortcutButtonCount",PlayerTemplate, m_specialPowerShortcutButtonCount),
        FIELD_PARSE_BOOL("IsObserver", PlayerTemplate, m_isObserver),
        FIELD_PARSE_BOOL("OldFaction", PlayerTemplate, m_oldFaction),
        FIELD_PARSE_INT("IntrinsicSciencePurchasePoints", PlayerTemplate, m_intrinsicSciencePurchasePoints),
