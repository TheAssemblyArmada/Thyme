...
void Setup_Hooks()
{
    ...
    Hook_Method(0x004E96F0, &DynamicVBAccessClass::_Deinit);
    Hook_Method(0x004E9C60, &DynamicVBAccessClass::Hook_Ctor);
    Hook_Method(0x004E9DA0, &DynamicVBAccessClass::Hook_Dtor);
    Hook_Method(0x004E9E10, &DynamicVBAccessClass::_Reset);
