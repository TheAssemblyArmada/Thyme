...
public:
    ...
    virtual int32_t Shutdown() { return 1; }
    ...
    virtual int32_t Set(FilterModes mode) = 0;
...
{
public:
    int32_t Get_Num_Passes() { return m_numPasses; }
    virtual int32_t Set(int32_t pass);
    virtual void Reset();
    virtual int32_t Init() = 0;
...
public:
    ...
    static void Set_Texture(int32_t index, TextureClass *texture) { s_textures[index] = texture; }
    static void Init();
    static void Shutdown();
    static int32_t Get_Shader_Passes(ShaderTypes shader);
    static int32_t Set_Shader(ShaderTypes shader, int32_t pass);
    ...
    static void Draw_Viewport(uint32_t color);
    ...
    static bool Set_Shroud_Tex(int32_t stage);
    static TextureClass *Get_Shader_Texture(int32_t stage) { return s_textures[stage]; }
...
private:
    static int32_t s_currentShaderPass;
...
{
public:
    virtual int32_t Set(int32_t pass) override;
...
public:
    ...
    virtual int32_t Set(FilterModes mode) override;
    virtual void Reset() override;
};
...
public:
    ...
    virtual int32_t Set(FilterModes mode) override;
    virtual void Reset() override;
    static void Set_Fade_Parameters(int32_t frames, int32_t direction)
    {
        s_curFadeFrame = 0;
        s_fadeFrames = frames;
...
private:
    static int32_t s_fadeFrames;
    static int32_t s_fadeDirection;
    static int32_t s_curFadeFrame;
...
extern int32_t g_w3dShadersPassCount[W3DShaderManager::ST_MAX];
