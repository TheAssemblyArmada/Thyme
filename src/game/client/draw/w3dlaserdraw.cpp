...
void W3DLaserDrawModuleData::Build_Field_Parse(MultiIniFieldParse &p)
{
    ...
    static const FieldParse dataFieldParse[] = {
        ...
        FIELD_PARSE_COLOR_INT("InnerColor", W3DLaserDrawModuleData, m_innerColor),
        FIELD_PARSE_COLOR_INT("OuterColor", W3DLaserDrawModuleData, m_outerColor),
        FIELD_PARSE_DURATION_UNSIGNED_INT("MaxIntensityLifetime", W3DLaserDrawModuleData, m_maxIntensityFrames),
        FIELD_PARSE_DURATION_UNSIGNED_INT("FadeLifetime", W3DLaserDrawModuleData, m_fadeFrames),
