...
public:
    ...
    virtual int32_t Get_Text_Length() { return m_textString.Get_Length(); }
    virtual void Notify_Text_Changed() {}
    virtual void Reset();
    virtual void Set_Font(GameFont *font) { m_font = font; }
    virtual GameFont *Get_Font() { return m_font; }
    virtual void Set_Word_Wrap(int32_t length) = 0;
    virtual void Set_Word_Wrap_Centered(bool on) = 0;
    virtual void Draw(int32_t x, int32_t y, int32_t w, int32_t h) = 0;
    virtual void Draw(int32_t x, int32_t y, int32_t w, int32_t h, int32_t unk1, int32_t unk2) = 0;
    virtual void Get_Size(int32_t *x, int32_t *y) = 0;
    virtual int32_t Get_Width(int32_t char_count) = 0;
    virtual void Set_Use_Hotkey(bool state, int32_t val) = 0;
