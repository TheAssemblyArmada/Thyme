...
public:
    ...
    virtual const char *Get_HName() const override;
    virtual int Get_Num_Frames() override;
    virtual float Get_Frame_Rate() override;
    virtual float Get_Total_Time() override;
    ...
    virtual int Get_Num_Pivots() const override;
