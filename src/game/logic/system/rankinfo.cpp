...
void RankInfoStore::Parse_Rank_Definition(INI *ini)
{
    ...
    if (ini->Get_Load_Type() == INI_LOAD_CREATE_OVERRIDES) {
        captain_assert(rank_level >= 1 && (unsigned)rank_level <= g_theRankInfoStore->m_infoStore.size(),
            0xDEAD0006,
        ...
        captain_assert(current_info != nullptr,
            0xDEAD0006,
        ...
        *new_info = *override_info;
        ...
        captain_assert(rank_level == g_theRankInfoStore->m_infoStore.size() + 1,
            0xDEAD0006,
